    ...
    <Card className="shadow-2xl border-0 bg-card/90 backdrop-blur-xl overflow-hidden">
      ...
      <CardHeader className="pb-6 pt-6">
        <div className="flex flex-col gap-5">
          ...
          <div className="space-y-3">
            {/* General Filter */}
            <Collapsible defaultOpen className="rounded-xl bg-muted/30 border border-border/50 overflow-hidden">
            ...
            {/* Leave Filters */}
            {showTimeOff && (
              <Collapsible defaultOpen className="rounded-xl bg-primary/5 border border-primary/20 overflow-hidden">
                <CollapsibleTrigger asChild>
                  <button className="flex items-center justify-between w-full p-3 hover:bg-primary/10 transition-colors">
                    <div className="flex items-center gap-2 text-sm font-medium text-primary">
                      <Palmtree className="h-4 w-4" />
                      <span>Verlof</span>
                    </div>
                    <ChevronDown className="h-4 w-4 text-primary transition-transform duration-200 [&[data-state=open]>svg]:rotate-180" />
                  </button>
                </CollapsibleTrigger>
                <CollapsibleContent>
                  <div className="flex flex-wrap items-center gap-3 px-3 pb-3">
            ...
            {/* Task Filters */}
            {showTasks && (
              <Collapsible defaultOpen className="rounded-xl bg-blue-500/5 border border-blue-500/20 overflow-hidden">
                <CollapsibleTrigger asChild>
                  <button className="flex items-center justify-between w-full p-3 hover:bg-blue-500/10 transition-colors">
                    <div className="flex items-center gap-2 text-sm font-medium text-blue-600 dark:text-blue-400">
                      <ClipboardList className="h-4 w-4" />
                      <span>Taken</span>
                    </div>
                    <ChevronDown className="h-4 w-4 text-blue-600 dark:text-blue-400 transition-transform duration-200 [&[data-state=open]>svg]:rotate-180" />
                  </button>
                </CollapsibleTrigger>
                <CollapsibleContent>
                  <div className="flex flex-wrap items-center gap-3 px-3 pb-3">
