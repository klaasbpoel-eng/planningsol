...
-- Update get_daily_production_by_period to support excluding digital gas types
CREATE OR REPLACE FUNCTION public.get_daily_production_by_period(p_from_date date, p_to_date date, p_location text DEFAULT NULL::text, p_exclude_digital boolean DEFAULT false)
...
-- Update get_customer_segments to support excluding digital gas types
CREATE OR REPLACE FUNCTION public.get_customer_segments(p_year integer, p_location text DEFAULT NULL::text, p_from_date date DEFAULT NULL::date, p_to_date date DEFAULT NULL::date, p_exclude_digital boolean DEFAULT false)
